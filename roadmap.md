...
* [x] **3.3. Kalman Filter Integration**
  * [x] **Task:** Implement the State Estimation vector ![][image3] in src/SignalProcessing/Kalman.hs.
  * [x] **Requirement:** FR-DSP-003
  * [x] **Implementation:** Standard linear Kalman filter (Zero-dependency Matrix operations).
  * [x] **Validation:**
    * [x] **Simulation:** Generate noisy sine wave (SNR 10dB). Compare Filter output vs. Ground Truth. RMSE must be ![][image4]mm. (Verified via `test/SignalProcessing/KalmanCheck.hs`)
