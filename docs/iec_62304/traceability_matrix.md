...
| FR-UI-003 | IEC-62366-5.1 | Structural navigation, assistive technology hooks, and skip-links | Phase 5.3 | `app/Control/WebUI.hs` | Visual Inspection | ✅ Complete |

## Safety Requirements (SR)

| Req ID | Quality Policy Origin | Description | Source Phase | Module | Verification Test | Status |
|---|---|---|---|---|---|---|
| SR-UI-001 | IEC-62366-5.1, IEC-62304-5.1.1 | Multi-modal encoding (color, shape, and symbol) for safety-critical states | Phase 5.3 | `app/Control/UI/Renderer.hs`, `app/Control/WebUI.hs` | Visual Inspection | ✅ Complete |
| SR-UI-002 | IEC-62366-5.1 | Formal usability verification checklist for visual inspections | Phase 5.3 | `docs/qms/usability_checklist.md` | Visual Inspection | ✅ Complete |
...
| SR-IPC-001 | ISO-13485-7.1 | Process boundary isolation; all IPC heartbeats are monitored by the safety daemon | Phase 4.4 | `Safety.Watchdog`, `app/Main.hs`, `app/VisualizerMain.hs` | Visual Inspection | ✅ Complete |
