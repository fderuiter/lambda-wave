...
| SR-IPC-001 | ISO-13485-7.1 | Process boundary isolation; all IPC heartbeats are monitored by the safety daemon | Phase 4.4 | `Safety.Watchdog`, `app/Main.hs`, `app/VisualizerMain.hs` | [`06 Safety Watchdog`](../../docs/architecture/06_safety_watchdog.md) | Visual Inspection | ✅ Complete |
...
| Req ID | Quality Policy Origin | Description | Source Phase | Module | Architecture Section | Verification Test | Status |
|---|---|---|---|---|---|---|---|
| MR-001 | ISO-13485-7.3.2 | FMCW Range Estimation (Equation 1) | Phase 3.1 | `SignalProcessing.FMCW` | [`04 Surface Mesher`](../../docs/architecture/04_surface_mesher.md) | `test/SignalProcessing/FMCWSpec.hs` | ✅ Complete |
| MR-002 | ISO-13485-7.3.2 | Chirp Z-Transform (Equation 2) | Phase 3.1 | `SignalProcessing.FMCW` | [`04 Surface Mesher`](../../docs/architecture/04_surface_mesher.md) | `test/SignalProcessing/FMCWSpec.hs` | ✅ Complete |
| MR-003 | ISO-13485-7.3.2 | Standard DFT (Equation 3) | Phase 3.1 | None | [`04 Surface Mesher`](../../docs/architecture/04_surface_mesher.md) | None | ❌ Incomplete |
| MR-004 | ISO-13485-7.3.2 | Phase Extraction (Equation 4) | Phase 3.2 | `SignalProcessing.FMCW` | [`04 Surface Mesher`](../../docs/architecture/04_surface_mesher.md) | `test/SignalProcessing/FMCWSpec.hs` | ✅ Complete |
| MR-005 | ISO-13485-7.3.2 | Displacement Calculation (Equation 5) | Phase 3.2 | `SignalProcessing.FMCW` | [`04 Surface Mesher`](../../docs/architecture/04_surface_mesher.md) | `test/SignalProcessing/FMCWSpec.hs` | ✅ Complete |
