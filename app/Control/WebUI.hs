...
httpApp token _ respond = respond $
    responseLBS status200
        ...
        , ("Content-Security-Policy", "default-src 'self'; connect-src 'self' ws: wss:; script-src 'self' 'sha256-5HFyeITiOPMMpCVIL0sg0NmgAi0L4GuXxDe8i+WP8rQ='; style-src 'self' 'sha256-hO21B28lmcyq55XuPNLkOjhQdIfctRJvI5LazHn+5Ws='")
